...
class SystemButtonGroup extends StatelessWidget {
  static const _systemButtonColor = darkBlue;
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        _Description(
          text: TetrasModalClass.of(context).sounds,
          child: _Button(
        ...
        _Description(
          text: TetrasModalClass.of(context).pause_resume,
          child: _Button(
              size: _SYSTEM_BUTTON_SIZE,
              color: _systemButtonColor,
              enableLongPress: false,
        ...
        _Description(
          text: TetrasModalClass.of(context).reset,
          child: _Button(
              size: _SYSTEM_BUTTON_SIZE,
              enableLongPress: false,
              color: Colors.red,
  ...
  Widget build(BuildContext context) {
    ...
    switch (direction) {
      case AxisDirection.right:
        widget = Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[child, SizedBox(width: 8), Text(text,style: TextStyle(color: grey),)]);
        break;
      case AxisDirection.left:
        widget = Row(
          children: <Widget>[Text(text,style: TextStyle(color: white),), SizedBox(width: 8), child],
          mainAxisSize: MainAxisSize.min,
        );
        break;
      case AxisDirection.up:
        widget = Column(
          children: <Widget>[Text(text,style: TextStyle(color: white),), SizedBox(height: 8), child],
          mainAxisSize: MainAxisSize.min,
        );
        break;
      case AxisDirection.down:
        widget = Column(
          children: <Widget>[child, SizedBox(height: 8), Text(text,style: TextStyle(color: grey),)],
          mainAxisSize: MainAxisSize.min,
        );
        break;
    }
